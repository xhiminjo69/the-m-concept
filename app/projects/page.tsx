      ...
      >
        ...
        <div className="absolute inset-0">
          <Image
            ...
            sizes="100vw"
          />
          {/* Layer 1 — directional dark gradient, heavier at bottom-left */}
          <div
          ...
          />
          {/* Layer 2 — radial vignette to push edges dark and spotlight the center */}
          <div
            className="absolute inset-0"
            style={{
              background:
        ...
        <div className="relative z-10 text-center px-6 md:px-10 lg:px-16 w-full" style={{ marginTop: '-2rem' }}>
          <span className="eyebrow" style={{ color: 'rgba(220,180,120,0.9)', letterSpacing: '0.22em' }}>Our Work</span>
          <div className="mt-5">
            <span
          ...
          >
            Three sectors. One standard of craft. Explore our work across
            commercial, hospitality, and residential categories.
          </p>
        </div>
      </section>
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-10">
            <div>
              ...
              <p className="font-body text-stone-400 leading-relaxed mt-4 max-w-sm" style={{ fontSize: '0.9375rem' }}>
                From a single bespoke piece to a full hotel fit-out, we work with
                you from brief to final installation.
              </p>
            </div>
